...
fn private_shared_defs_authority_is_exact_and_not_credentialized() {
    ...
    assert!(lock
        .contains("\"repository\": \"https://github.com/ORESoftware/k8s-libs-and-shared-defs\""));
    assert!(lock.contains("\"revision\": \"c8bdc06d74746acc6439f9527ebd02697fdf028b\""));
...
fn zed_manifest_keeps_the_private_dependency_instead_of_vendoring_around_it() {
    ...
    assert!(zpkg.contains("\"oresoftware/k8s-libs-and-shared-defs\" = \"^0.2.0\""));
